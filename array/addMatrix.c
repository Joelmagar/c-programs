...
void addFunction(int rowLen,int colLen, int arr1[rowLen][colLen], int arr2[rowLen][colLen],int add[rowLen][colLen]);
int main(){
    ...
    int add[rowLen][colLen];
    addFunction(rowLen,colLen,arr1,arr2,add);
